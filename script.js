...
<body>
    ...
    <header> 
        <a href="#" class="logo"><span>Y</span>ash</a>
        <ul class="navlist">
    ...
    <section class="home" id="home">
        <div class="hero-info"> 
            ...
            <h1>Hi I'm Yash Kumar Jaiswal</h1>

            <div class="text-animate">
                <h2>Frontend Developer</h2> 
            </div>

            <p>Logical and self-motivated individual with strong foundation in problem solving and web development skills. Ability to translate business requirements into innovative software solutions. Excellent teamwork, interpersonal and communication skills. Looking to start a career as an entry-level professional with a reputed IT company</p>

            <div class="btn-box">
                <a href="mailto:yashgjaiswal691@gmail.com" class="btn">Hire Me Now ! <i class='bx bx-right-arrow-alt' ></i></a>
    ...
    <section class="about" id="about">
        ...
        <div class="about-content">
            ...
            <h3>Pursuing my B.Tech in Computer Science Artificial Intelligence And Machine Learning </h3>
            <p>I want to be a part of an organization where I can contribute my best technical skills, learn and grow, and make valuable contributions to the organization while enhancing my personal well-being.</p>
            <div class="about-btn">
            ...
            <div class="content-btn">
                <div class="content">
                    ...
                    <span>C++ , Core Java </span>
                </div>
                <div class="text-box">
                    <p>domain-specific language (DSL)</p>
                    <span>SQL</span>
                </div>
                <div class="text-box">
                    <p>Web Development </p>
                ...
                <div class="content">
                    <div class="text-box">
                    <p>Achieved 5 stars on  Hackerrank</p>
                ...
                <div class="education-details">
                    <div class="education-item">
                        ...
                        <p>2020 - 2024</p>
                        <p>Computer Science - Artificial Intelligence And Machine Learning</p>
                        <p>8.38 CGPA</p>
                    </div>
                    <!-- You can add more education items for other degrees or qualifications -->
                </div>
                <div class="text-box">
    ...
    <section class="portfolio" id="portfolio">
        ...
        <div class="fillter-buttons">
            ...
            <button class="button" data-filter=".branding">Branding Design</button>
        </div>
        ...
        <div class="portfolio-gallery">
            ...
            <div class="portfolio-box mix uiux">
                <div class="portfolio-content">
                    <h3>UI/UX Design</h3>
                    <p>m ipsum dolor sit amet consectetur adipisicing elit. Asperiores, solutLorea.</p>
                    <a href="#" class="readMore">Explore More</a>
                </div>
                <div class="portfolio-img">
